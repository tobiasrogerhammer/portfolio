      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="hidden md:block">
            <Button asChild size="sm" className="text-xs lg:text-sm px-3 lg:px-4 py-2 lg:py-2.5" style={{ backgroundColor: '#124D95', color: '#E9F5FF', borderColor: '#124D95' }}>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-background border-t border-border">
              ...
              <div className="px-3 py-2">
                <Button asChild className="w-full text-sm py-2.5" style={{ backgroundColor: '#124D95', color: '#E9F5FF', borderColor: '#124D95' }}>
                  <a href="/Tobias_Hammer_Resume.pdf" download>
                    Download Resume
                  </a>
                </Button>
